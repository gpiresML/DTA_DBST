...
% =============================
if update == 0
    nEventstarget    = size(ytargetTRAIN,3)    / nepoch;
    nEventsNONtarget = size(yNONtargetTRAIN,3) / nepoch;

    [ztargetTRAIN, zNONtargetTRAIN] = ...
        gp_average_epoch(ytargetTRAIN, yNONtargetTRAIN, ...
                         nEventstarget, nEventsNONtarget, nepoch);
end

[ztargetTEST, zNONtargetTEST] = ...
    gp_average_epoch(ytargetTEST, yNONtargetTEST, ...
                     size(ytargetTEST,3)/nepoch, ...
                     size(yNONtargetTEST,3)/nepoch, nepoch);
...
% CLASSIFICATION
% =============================
[result, std_nt_tre, train, n1, n2] = jf_FLD( zspatialTRAIN_t, zspatialTRAIN_nt, zspatialTEST_t, zspatialTEST_nt, feat_sel, nfeat);
